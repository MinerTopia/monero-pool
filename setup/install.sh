...
echo "This install will fail if you are running on anything other than a brand new Ubuntu 16x install."
sleep 15
...
cd ~
echo "[Downloading the latest teracycle-pool]"
sleep 15
